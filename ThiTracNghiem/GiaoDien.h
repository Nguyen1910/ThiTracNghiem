...
void giaoDienNhapSV(int x, int y, int w, int h, int color, string maLop, string tenLop) {
	SetColor(9);
	gotoxy(x + 5, y - 4); cout << "Ma lop: " + maLop;
	gotoxy(x + 5, y -3); cout << "Ten lop: " + tenLop;
...
void giaoDienNhapCauHoi(string tenMH, int x, int y, int w, int h, int color) {
	...
	gotoxy(x + w / 2 - 2, y -1); cout << "NHAP CAU HOI THI MON " + toUpCaps(tenMH);
